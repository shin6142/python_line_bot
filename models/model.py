...
class User(db.Model):
    ...
    hash_line_id = db.Column(db.String(80), unique=True)
...
def add_user(username, line_id, hash_line_id):
    if username != 'favicon.ico':
        new_user = User(username=username, line_id=line_id, hash_line_id=hash_line_id)
